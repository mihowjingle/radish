...
Or 4. at the time of the assignment, we evaluate the `type`, as if taking a snapshot of the `slot`'s state, we create a separate copy

... which is basically an implicit function call... hmm...